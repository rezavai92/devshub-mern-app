    ...
    <div>
      <div className="container">
        ...
        <div className="skills">
          <h6>Top Skills :</h6>
          {skills.map((s) => {
            return <div className="skill">{s}</div>;
          })}
        </div>
        {social.github ||
        social.facebook ||
        ...
        <div className="about-posts">
          <div className="about">
            <Button variant="light" onClick={aboutHandler}>
              {" "}
          ...
          <div className="">
            <Button variant="light" onClick={postHandler}>
          ...
          <div>
            <div className="pro-education">
              ...
              <div className="educationFlex">
                {education.map((edu, index) => {
                  return (
                    <div className="mappedEducaionPro" key={edu._id}>
                      <div>
                        <h3> {index + 1}.</h3>
                      </div>
                      <div>
                        <p>
                          {"School : "}{" "}
                          <span style={{ color: "blue" }}>{edu.school}</span>
                        </p>
                      </div>
                      <div>
                        <p>
                      ...
                      <div>
                        <p>
                          ...
                          <span style={{ color: "blue" }}>{edu.from.split("T")[0]} </span>
                        </p>
                      </div>
                      ...
                      <div>
                        <p>
                          {"To : "}
                          <span style={{ color: "blue" }}>{edu.to.split('T')[0]} </span>
                        </p>
                      </div>
            ...
            <div className="experience-pro">
              ...
              {experience.map((ex, index) => {
                return (
                  <div className="mappedEducationPro">
                    <div>
                      <h3> {index + 1}.</h3>
                    </div>
